...
models_dir = f'../artifacts/best_models/SAC/'
logdir = f'../../artifacts/logs/SAC/'
...
X_train, X_test, y_train, y_test = get_dataset(exp_name='SAC_sb3')
...
model = SAC(
    ...
    env=train_env,
    verbose=1,
    tensorboard_log="../artifacts/logs/SAC"
)
...
for i in range(30):
    model.learn(
        ...
        tb_log_name="../artifacts/logs/SAC/",
        callback=callback
    )
